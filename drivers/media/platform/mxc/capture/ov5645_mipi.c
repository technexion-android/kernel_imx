 ...
 */
static struct sensor_data ov5645_data;
...
static struct reg_value ov5645_setting_15fps_VGA_640_480[] = {
...
static struct reg_value ov5645_setting_30fps_XGA_1024_768[] = {
...
static struct reg_value ov5645_setting_15fps_XGA_1024_768[] = {
	{0x3035, 0x22, 0, 0}, {0x3036, 0x38, 0, 0}, {0x3c07, 0x08, 0, 0},
	{0x3c09, 0x1c, 0, 0}, {0x3c0a, 0x9c, 0, 0}, {0x3c0b, 0x40, 0, 0},
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
...
static struct reg_value ov5645_setting_30fps_QVGA_320_240[] = {
	{0x3035, 0x14, 0, 0}, {0x3036, 0x38, 0, 0}, {0x3c07, 0x08, 0, 0},
	{0x3c09, 0x1c, 0, 0}, {0x3c0a, 0x9c, 0, 0}, {0x3c0b, 0x40, 0, 0},
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
...
static struct reg_value ov5645_setting_15fps_QVGA_320_240[] = {
	{0x3035, 0x22, 0, 0}, {0x3036, 0x38, 0, 0}, {0x3c07, 0x08, 0, 0},
	{0x3c09, 0x1c, 0, 0}, {0x3c0a, 0x9c, 0, 0}, {0x3c0b, 0x40, 0, 0},
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
...
static struct reg_value ov5645_setting_15fps_QCIF_176_144[] = {
	{0x3035, 0x22, 0, 0}, {0x3036, 0x38, 0, 0}, {0x3c07, 0x08, 0, 0},
	{0x3c09, 0x1c, 0, 0}, {0x3c0a, 0x9c, 0, 0}, {0x3c0b, 0x40, 0, 0},
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
...
static struct reg_value ov5645_setting_15fps_NTSC_720_480[] = {
	{0x3035, 0x22, 0, 0}, {0x3036, 0x38, 0, 0}, {0x3c07, 0x08, 0, 0},
	{0x3c09, 0x1c, 0, 0}, {0x3c0a, 0x9c, 0, 0}, {0x3c0b, 0x40, 0, 0},
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
...
static struct reg_value ov5645_setting_30fps_PAL_720_576[] = {
	{0x3035, 0x12, 0, 0}, {0x3036, 0x38, 0, 0}, {0x3c07, 0x08, 0, 0},
	{0x3c09, 0x1c, 0, 0}, {0x3c0a, 0x9c, 0, 0}, {0x3c0b, 0x40, 0, 0},
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
...
static struct reg_value ov5645_setting_15fps_PAL_720_576[] = {
	{0x3035, 0x22, 0, 0}, {0x3036, 0x38, 0, 0}, {0x3c07, 0x08, 0, 0},
	{0x3c09, 0x1c, 0, 0}, {0x3c0a, 0x9c, 0, 0}, {0x3c0b, 0x40, 0, 0},
	{0x3820, 0x41, 0, 0}, {0x3821, 0x07, 0, 0}, {0x3814, 0x31, 0, 0},
	{0x3815, 0x31, 0, 0}, {0x3800, 0x00, 0, 0}, {0x3801, 0x00, 0, 0},
...
static struct reg_value ov5645_setting_15fps_720P_1280_720[] = {
...
static struct ov5645_mode_info ov5645_mode_info_data[2][ov5645_mode_MAX + 1] = {
	{
		...
		ov5645_setting_15fps_VGA_640_480,
		ARRAY_SIZE(ov5645_setting_15fps_VGA_640_480)},
		{ov5645_mode_QVGA_320_240, SUBSAMPLING, 320,  240,
		ov5645_setting_15fps_QVGA_320_240,
		ARRAY_SIZE(ov5645_setting_15fps_QVGA_320_240)},
		{ov5645_mode_NTSC_720_480, SUBSAMPLING, 720, 480,
		ov5645_setting_15fps_NTSC_720_480,
		ARRAY_SIZE(ov5645_setting_15fps_NTSC_720_480)},
		{ov5645_mode_PAL_720_576, SUBSAMPLING, 720, 576,
		ov5645_setting_15fps_PAL_720_576,
		ARRAY_SIZE(ov5645_setting_15fps_PAL_720_576)},
		{ov5645_mode_720P_1280_720, SUBSAMPLING, 1280, 720,
		ov5645_setting_15fps_720P_1280_720,
		ARRAY_SIZE(ov5645_setting_15fps_720P_1280_720)},
		...
		ov5645_setting_15fps_QCIF_176_144,
		ARRAY_SIZE(ov5645_setting_15fps_QCIF_176_144)},
		{ov5645_mode_XGA_1024_768, SUBSAMPLING, 1024, 768,
		ov5645_setting_15fps_XGA_1024_768,
		ARRAY_SIZE(ov5645_setting_15fps_XGA_1024_768)},
	},
	{
		{ov5645_mode_VGA_640_480, SUBSAMPLING, 640,  480,
		...
		{ov5645_mode_QVGA_320_240, SUBSAMPLING, 320,  240,
		ov5645_setting_30fps_QVGA_320_240,
		ARRAY_SIZE(ov5645_setting_30fps_QVGA_320_240)},
		{ov5645_mode_NTSC_720_480, SUBSAMPLING, 720, 480,
		ov5645_setting_30fps_NTSC_720_480,
		ARRAY_SIZE(ov5645_setting_30fps_NTSC_720_480)},
		{ov5645_mode_PAL_720_576, SUBSAMPLING, 720, 576,
		ov5645_setting_30fps_PAL_720_576,
		ARRAY_SIZE(ov5645_setting_30fps_PAL_720_576)},
		{ov5645_mode_720P_1280_720, SUBSAMPLING, 1280, 720,
		...
		{ov5645_mode_XGA_1024_768, SUBSAMPLING, 1024, 768,
		ov5645_setting_30fps_XGA_1024_768,
		ARRAY_SIZE(ov5645_setting_30fps_XGA_1024_768)},
	},
};
...
static int ov5645_power_on(struct device *dev)
{
	int ret = 0;
			    ...
			    enum ov5645_mode mode, enum ov5645_mode orig_mode)
{
	...
	} else if (frame_rate == ov5645_15_fps) {
		/* dump the first nine frames: 1/15*9 */
		msec_wait4stable = 600;
	} else if (frame_rate == ov5645_30_fps) {
...
static int ioctl_g_ifparm(struct v4l2_int_device *s, struct v4l2_ifparm *p)
{
	...
	memset(p, 0, sizeof(*p));
	p->u.bt656.clock_curr = ov5645_data.mclk;
	pr_debug("   clock_curr=mclk=%d\n", ov5645_data.mclk);
	p->if_type = V4L2_IF_TYPE_BT656;
	p->u.bt656.mode = V4L2_IF_TYPE_BT656_MODE_NOBT_8BIT;
	p->u.bt656.clock_min = OV5645_XCLK_MIN;
	p->u.bt656.clock_max = OV5645_XCLK_MAX;
...
static int ioctl_g_ctrl(struct v4l2_int_device *s, struct v4l2_control *vc)
{
	...
	case V4L2_CID_BRIGHTNESS:
		vc->value = ov5645_data.brightness;
		break;
	case V4L2_CID_HUE:
		vc->value = ov5645_data.hue;
		break;
	case V4L2_CID_CONTRAST:
		vc->value = ov5645_data.contrast;
		break;
	case V4L2_CID_SATURATION:
		vc->value = ov5645_data.saturation;
		break;
	case V4L2_CID_RED_BALANCE:
		vc->value = ov5645_data.red;
		break;
	case V4L2_CID_BLUE_BALANCE:
		vc->value = ov5645_data.blue;
		break;
	case V4L2_CID_EXPOSURE:
		vc->value = ov5645_data.ae_mode;
		break;
	default:
		ret = -EINVAL;
	}
...
static int ioctl_s_ctrl(struct v4l2_int_device *s, struct v4l2_control *vc)
{
	...
	pr_debug("In ov5645:ioctl_s_ctrl %d\n",
		 vc->id);
...
{
	if (fsize->index > ov5645_mode_MAX)
		return -EINVAL;

	fsize->pixel_format = ov5645_data.pix.pixelformat;
	fsize->discrete.width =
			max(ov5645_mode_info_data[0][fsize->index].width,
			    ov5645_mode_info_data[1][fsize->index].width);
	fsize->discrete.height =
			max(ov5645_mode_info_data[0][fsize->index].height,
			    ov5645_mode_info_data[1][fsize->index].height);
	return 0;
}
					 ...
					 struct v4l2_frmivalenum *fival)
{
	...
	for (i = 0; i < ARRAY_SIZE(ov5645_mode_info_data); i++)
		for (j = 0; j < (ov5645_mode_MAX + 1); j++)
			if (fival->pixel_format == ov5645_data.pix.pixelformat
			 && fival->width == ov5645_mode_info_data[i][j].width
			 && fival->height == ov5645_mode_info_data[i][j].height
...
{
	if (fmt->index > ov5645_mode_MAX)
		return -EINVAL;

	fmt->pixelformat = ov5645_data.pix.pixelformat;
 ...
 * enumeration.
 */
static struct v4l2_int_ioctl_desc ov5645_ioctl_desc[] = {
...
static struct v4l2_int_slave ov5645_slave = {
	.ioctls = ov5645_ioctl_desc,
	.num_ioctls = ARRAY_SIZE(ov5645_ioctl_desc),
};

static struct v4l2_int_device ov5645_int_device = {
	.module = THIS_MODULE,
	.name = "ov5645_mipi",
			...
			const struct i2c_device_id *id)
{
	...
	ov5645_data.pix.pixelformat = V4L2_PIX_FMT_UYVY;
	ov5645_data.pix.width = 640;
	ov5645_data.pix.height = 480;
	...
	ov5645_int_device.priv = &ov5645_data;
	retval = v4l2_int_device_register(&ov5645_int_device);
...
static int ov5645_remove(struct i2c_client *client)
{
	v4l2_int_device_unregister(&ov5645_int_device);
...
/*!
 * ov5645 init function
 * Called by insmod ov5645_camera.ko.
 *
 * @return  Error code indicating success or failure
 */
static __init int ov5645_init(void)
{
	u8 err;

	err = i2c_add_driver(&ov5645_i2c_driver);
	if (err != 0)
...
/*!
 * OV5645 cleanup function
 * Called on rmmod ov5645_camera.ko
 *
 * @return  Error code indicating success or failure
 */
static void __exit ov5645_clean(void)
{
	i2c_del_driver(&ov5645_i2c_driver);
}

module_init(ov5645_init);
module_exit(ov5645_clean);
